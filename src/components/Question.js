...
const Question = ({ ques, i }) => {
    ...
    return (
        <div
            className='w-[30%] max-lg:w-[45%] max-md:w-[45%] max-sm:w-[90%] h-[37%] cursor-pointer rounded-xl button-background mx-2 my-8 hover:transform hover:scale-y-110 hover:origin-top hover:transition-transform'
            ...
            <div className='flex flex-col justify-evenly h-full'>
                <div className='flex justify-between px-5'>
                    <img
                        ...
                        width={50}
                    />
                    <div className='text-2xl pr-4 text-gray-200'>{i + 1}. {name}</div>
                </div>
                <div className='flex justify-between px-10 text-md'>
                    <div className='border-width rounded-lg p-1'>
                        <span className='text-green-200 md:mr-3'>©</span>
                        UseState
                    </div>
