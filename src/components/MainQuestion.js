    ...
    return (
        <div className='flex flex-col'>
            ...
            <div className='flex h-[calc(100vh-3.12rem)]'>
                <div className='w-[30%] flex flex-col justify-center items-center backgound-color space-y-7 max-md:space-y-4 max-sm:w-[100%]'>
                    <div className='text-white text-3xl w-[90%]'>
                        {name}
                    </div>
                    <div className='w-[90%] flex items-center space-x-5 text-gray-300'>
                        <div>Topic: </div>
                        <div className='border-width rounded-lg p-1 text-sm w-[15%] flex justify-center'>
                            {topic}
                        </div>
                    </div>
                    ...
                    <div className='w-[90%]' onClick={() => handleCLick()}>
                        <button className='bg-slate-400 p-3 text-white rounded-md'>Click here for Solution</button>
                    </div>
                    <div className='w-[90%]'>
